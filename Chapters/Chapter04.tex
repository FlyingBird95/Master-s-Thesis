...
\begin{itemize}
    ...
    \item \textbf{not port 14100}: this port is filtered out, as this is the default port for communicating with other nodes. This option can be configured, such that is contains more ports;
