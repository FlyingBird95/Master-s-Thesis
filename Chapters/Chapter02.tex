...
Cloud Computing Monitoring exists from the beginning of Cloud Computing. \autoref{ch:introduction} already described that it is an essential feature in controlling and managing hardware and software infrastructures. This section provides background information
